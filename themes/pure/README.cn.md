...
[首页](http://cofess.github.io/) | [归档](http://cofess.github.io/archives/) | [分类](http://cofess.github.io/categories/) | [标签](http://cofess.github.io/tags/) | [项目](http://cofess.github.io/repository/) | [书单](http://cofess.github.io/books/) | [外链](http://cofess.github.io/links/) | [关于](http://cofess.github.io/about/)
...
添加多个外部链接，我们只需要根据上面的格式重复填写即可。

. 将 Name 改为外部链接的名字，例如 Cofess。

. http://example.com 为外部链接的地址。

. http://example.com/avatar.png 为外部链接的头像。
